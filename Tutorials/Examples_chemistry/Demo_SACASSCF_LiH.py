...
#======================================================================================== "Y88P"  
#
# A sample code to demonstrate how to implement a State-Averaged CASSCF method with 
...
for r in (list_r):
    ...
    while (abs(E_new - E_old) > E_thresh):
        ...
        one_rdm_A, two_rdm_A = qnb.fermionic.tools.build_full_mo_1rdm_and_2rdm_for_AS(Psi_A,
                                                                                      a_dagger_a,
                                                                                      frozen_indices,
                                                                                      active_indices,
                                                                                      N_MO_total)
        one_rdm_B, two_rdm_B = qnb.fermionic.tools.build_full_mo_1rdm_and_2rdm_for_AS(Psi_B,
                                                                                      a_dagger_a,
                                                                                      frozen_indices,
                                                                                      active_indices,
                                                                                      N_MO_total)
        ...
        C_ref, E_new, h_MO, g_MO = qnb.fermionic.tools.orbital_optimisation_newtonraphson(one_rdm_SA,
                                                                                          two_rdm_SA,
                                                                                          active_indices,
                                                                                          frozen_indices,
                                                                                          virtual_indices,
